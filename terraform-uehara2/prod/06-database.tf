...
resource "aws_db_instance" "rds_instance" {
  ...
  # snapshot_identifier    = "rds:mydatabasev2-2025-11-15-12-15"
  snapshot_identifier    = "test-snap"
  ...
  # instance_class         = "db.t3.xlarge"               # 本番環境用（4vCPU, 16GB RAM, 1365 max_connections）
  db_name                = var.db_name
  ...
  deletion_protection = true   # 再作成のため一時的に無効化
...
#   snapshot_identifier    = "rds:uehara1028-before-renew-wizstg"
