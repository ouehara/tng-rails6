  ...
  (function() {
      ...
      var Util = {
        ...
        findOrCreateMatchingTextNodes: function(document, element, match) {
          ...
          while ((currentNode = treeWalker.nextNode()) !== null) {
            if (currentNode.nodeType > 3) {
              ...
              if (
                !startReached &&
                match.start < currentTextIndex + currentNode.nodeValue.length
              ) {
                startReached = true;
        ...
        getClosestBlockContainer: function(node) {
          return Util.traverseUp(node, function(node) {
            return (
              Util.isBlockContainer(node) || Util.isMediumEditorElement(node)
            );
          });
        },
        ...
        getFirstSelectableLeafNode: function(element) {
          ...
          element = Util.traverseUp(element, function(el) {
            return (
              Util.emptyElementNames.indexOf(el.nodeName.toLowerCase()) === -1
            );
          });
      ...
      var Selection = {
        ...
        exportSelection: function(root, doc) {
          ...
          if (selection.rangeCount > 0) {
            ...
            if (start !== 0) {
              var emptyBlocksIndex = this.getIndexRelativeToAdjacentEmptyBlocks(
                doc,
                root,
        ...
        importSelectionMoveCursorPastBlocks: function(doc, root, index, range) {
          ...
          if (
            ...
            MediumEditor.util.isBlockContainer(startContainer.previousSibling)
          ) {
            startBlock = startContainer.previousSibling;
          } else {
            startBlock = MediumEditor.util.getClosestBlockContainer(
              startContainer
            );
          }
        ...
        getIndexRelativeToAdjacentEmptyBlocks: function(
          ...
          var closestBlock = MediumEditor.util.getClosestBlockContainer(
              cursorContainer
            ),
        ...
        getSelectedParentElement: function(range) {
          ...
          if (
            ...
            range.startContainer.childNodes[range.startOffset].nodeType !== 3
          ) {
      ...
      Events.prototype = {
        ...
        handleDocumentSelectionChange: function(event) {
          ...
          if (event.currentTarget && event.currentTarget.activeElement) {
            ...
            this.base.elements.some(function(element) {
              if (
                MediumEditor.util.isDescendant(element, activeElement, true)
              ) {
    ...
    (function() {
      ...
      Button.isBuiltInButton = function(name) {
        return (
          typeof name === "string" &&
          MediumEditor.extensions.button.prototype.defaults.hasOwnProperty(name)
        );
      };
    ...
    (function() {
      ...
      var AnchorForm = MediumEditor.extensions.form.extend({
        ...
        ensureEncodedParam: function(param) {
          ...
          return (
            key +
            (val === undefined ? "" : "=" + this.ensureEncodedUriComponent(val))
          );
        },
      ...
      var AnchorPreview = MediumEditor.Extension.extend({
        ...
        showPreview: function(anchorEl) {
          ...
          if (this.previewValueSelector) {
            ...
            this.anchorPreview.querySelector(this.previewValueSelector).href =
              anchorEl.attributes.href.value;
          }
        ...
        handleEditableMouseover: function(event) {
          ...
          this.instanceHandleAnchorMouseout = this.handleAnchorMouseout.bind(
            this
          );
          this.on(
        ...
        attachPreviewHandlers: function() {
          ...
          this.instanceHandlePreviewMouseover = this.handlePreviewMouseover.bind(
            this
          );
          this.instanceHandlePreviewMouseout = this.handlePreviewMouseout.bind(
            this
          );
      ...
      var AutoLink = MediumEditor.Extension.extend({
        ...
        performLinking: function(contenteditable) {
          /*
            ...
            */
          var blockElements = MediumEditor.util.splitByBlockElements(
              contenteditable
            ),
              ...
              if (spans[i].getAttribute("data-href") === trimmedTextContent) {
                var charactersTrimmed =
                  ...
                  subtree = MediumEditor.util.splitOffDOMTree(
                    spans[i],
                    this.splitTextBeforeEnd(spans[i], charactersTrimmed)
                  );
        ...
        findLinkableText: function(contenteditable) {
          ...
          while ((match = LINK_REGEXP.exec(textContent)) !== null) {
            ...
            matchOk =
              (match.index === 0 ||
                WHITESPACE_CHARS.indexOf(textContent[match.index - 1]) !==
                  -1) &&
    ...
    */
      ...
      var PasteHandler = MediumEditor.Extension.extend({
        ...
        handleKeydown: function(event, editable) {
          ...
          if (
            !(
              MediumEditor.util.isKey(event, MediumEditor.util.keyCode.V) &&
              MediumEditor.util.isMetaCtrlKey(event)
            )
          ) {
            return;
      ...
      var Toolbar = MediumEditor.Extension.extend({
        ...
        modifySelection: function() {
          ...
          if (
            ...
            var adjacentNode = MediumEditor.util.findAdjacentTextNodeWithContent(
            ...
            if (adjacentNode) {
              var offset = 0;
              while (
                adjacentNode.nodeValue.substr(offset, 1).trim().length === 0
              ) {
                offset = offset + 1;
              }
        ...
        checkState: function() {
          ...
          if (
            !MediumEditor.selection.selectionContainsContent(this.document) ||
          ...
          if (this.sticky) {
            ...
            if (
              ...
              toolbarElement.style.top =
                containerTop + container.offsetHeight - toolbarHeight + "px";
    ...
    (function() {
        ...
        if (
          ...
          if (
            ...
            (node.previousElementSibling &&
              node.previousElementSibling.nodeName.toLowerCase() !== "br" &&
        ...
        if (!element.getAttribute("data-medium-editor-element")) {
          ...
          if (!this.instanceHandleEditableKeydownEnter) {
            if (
              ...
              this.instanceHandleEditableKeydownEnter = handleDisabledEnterKeydown.bind(
                this
              );
              this.subscribe(
                "editableKeydownEnter",
      ...
      function initExtensions() {
        ...
        if (!toolbarExtension && isToolbarEnabled.call(this)) {
          ...
          var toolbarOptions = MediumEditor.util.extend(
            ...
            {
              allowMultiParagraphSelection: this.options
                .allowMultiParagraphSelection // deprecated
            }
          );
      ...
      MediumEditor.prototype = {
              ...
              if (MediumEditor.extensions.button.isBuiltInButton(name)) {
                if (opts) {
                  merged = MediumEditor.util.defaults(
                    {},
                    opts,
                    MediumEditor.extensions.button.prototype.defaults[name]
                  );
        ...
        importSelection: function(selectionState, favorLaterSelectionAnchor) {
          ...
          var editableElement = this.elements[
            selectionState.editableElementIndex || 0
          ];
        ...
        createLink: function(opts) {
          ...
          try {
                  ...
                  textNodes = MediumEditor.util.findOrCreateMatchingTextNodes(
                    ...
                    fragment,
                    {
                      start:
                        ...
                        exportedSelection.end - modifiedExportedSelection.start,
            ...
            if (
              ...
              customEvent = this.options.ownerDocument.createEvent(
                "HTMLEvents"
              );
        ...
        resetContent: function(element) {
          ...
          if (element) {
            ...
            if (index !== -1) {
              this.setContent(
                initialContent[element.getAttribute("medium-editor-index")],
                index
              );
            }
            return;
