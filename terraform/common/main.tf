...
# cd infra/common
# terraform init
# terraform plan -var-file="terraform_common_d2cxstg.tfvars"
# terraform apply -var-file="terraform_common_d2cxstg.tfvars"
# -----------------------------------------------
# terraform plan -var-file="terraform_common_wizstg.tfvars"
# terraform apply -var-file="terraform_common_wizstg.tfvars"
#
# 20251001
...
terraform {
  ...
  backend "s3" {
    ...
    bucket         = "s3-terraform-v-rails-1001-412742703218" # TODO 作成したS3バケット名をハードコートしてください。
