...
app_identifier = "w-rails-1115" # アプリケーション識別子
owner_tag = "wizprod"
environment = "prod" # 環境設定 (dev, prod のみ許可)
...
# 所有しているドメイン名を指定してください。そうじゃないとドメインの検証に失敗します
domain_name = "w-rails-prod-tokyo.sukejima.com"
...
# Rails設定
# 本番環境では適切なsecret_key_baseに変更してください
